		...
		if($_GET['hal'] == "edit")
		{
			...
			if($edit) //jika edit sukses
			{
				echo "<script>
						...
						document.location='daftar-tabel-ti.php';
				     </script>";
			}
			else
			{
        ...
        <form action="" method="POST">
            <div class="card mt-3">
                <div class="card-header bg-primary text-white text-center">
                    <h3>Input/ Edit/ Hapus Data Mahasiswa TI</h3>
                </div>
                <div class="card-body">
...
<?php
    $no = 1;
    $tampil = mysqli_query($host, "SELECT * FROM mahasiswa where nipd like 'TI%' ");
...
?>
                    <tr>
                        ...
                        <td ><?=$data['kelas']?></td>
                        <td>
                            <a href="daftar-tabel-ti.php?hal=edit&id=<?=$data['nipd']?>" class="btn btn-warning"> Edit </a>
                            <a href="daftar-tabel-ti.php?hal=hapus&id=<?=$data['nipd']?>" 
